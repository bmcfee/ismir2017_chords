...
The second model, denoted \emph{CR2}, uses a second bi-GRU layer to map $h(t)$ to an intermediate representation $h_2(t)$ prior to frame-wise decoding by \cref{eq:decode}.
...
Third, out-of-gamut chords all map to a common class \texttt{X}, despite having disparate roots or general tonal content.
